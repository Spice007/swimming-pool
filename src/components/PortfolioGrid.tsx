...
const projects: Project[] = [
  {
    ...
    image: "/images/custom-pool-1.jpg",
  ...
  },
  {
    ...
    image: "/images/custom-pool-2.jpg",
  ...
  },
  {
    ...
    image: "/images/custom-pool-3.jpg",
  ...
  },
  {
    ...
    image: "/images/custom-pool-4.jpg",
  ...
  },
  {
    ...
    image: "/images/custom-pool-5.jpg",
  ...
  {
    id: "residential-lap-pool",
    name: "Suburban Lap Pool",
    location: "Lekki, Lagos",
    category: "Residential Pool",
    image: "/images/custom-pool-6.jpg",
    heightClass: "h-[380px] md:h-[460px]",
    description: "A spacious residential lap pool featuring integrated stepping stones and shallow sun-bathing sections. The blue mosaic tiling provides a vibrant contrast to the light coping stones.",
    area: "1,500 Sq Ft",
    timeframe: "10 Weeks",
    materials: ["Blue Mosaic Tiles", "Textured Sandstone Coping"],
    features: ["Lap Swimming Lane", "Shallow Sun Shelf", "Submerged Seating"],
  },
  {
    id: "kidney-oasis",
    name: "The Covered Oasis",
    location: "Ikeja, Lagos",
    category: "Pool Renovation",
    image: "/images/custom-pool-7.jpg",
    heightClass: "h-[350px] md:h-[420px]",
    description: "A renovated freeform kidney-shaped pool enclosed within a covered recreational deck. The surrounding artificial turf and warm stone accents create a comfortable all-weather retreat.",
    area: "800 Sq Ft",
    timeframe: "6 Weeks",
    materials: ["Cobalt Blue Tiles", "Premium Artificial Turf", "Natural Stone Decking"],
    features: ["Freeform Kidney Shape", "Covered Deck Area", "Stainless Steel Ladders"],
  },
  {
    id: "commercial-lap",
    name: "Estate Recreational Pool",
    location: "Abuja, Nigeria",
    category: "Commercial Pool",
    image: "/images/custom-pool-8.jpg",
    heightClass: "h-[400px] md:h-[500px]",
    description: "A large-scale commercial swimming pool designed for a residential estate. The expansive deck and multi-lane design accommodate high capacities while maintaining a luxurious aesthetic.",
    area: "3,500 Sq Ft",
    timeframe: "14 Weeks",
    materials: ["Commercial Grade Mosaics", "Non-Slip Ceramic Decking", "Stainless Steel Hardware"],
    features: ["Multi-Lane Capacity", "Extended Lounge Deck", "Heavy-Duty Filtration System"],
  }
];
